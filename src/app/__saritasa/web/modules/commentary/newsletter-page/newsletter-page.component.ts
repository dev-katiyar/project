...
@Component({
  ...
  styleUrls: ['./newsletter-page.component.scss', './../commentary.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
/** Component for Newsletter page */
@DestroyableComponent()
export class NewsletterPageComponent extends CommentaryPageBase<WpPost, WpPostFilters> {
  ...
  protected readonly filters$: Observable<WpPostFilters> = this.route.queryParams.pipe(
    ...
    map(filters => ({
      ...filters,
      categories: [WpPostCategories.ProNewsletter],
    })),
  );
