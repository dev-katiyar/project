...
@Component({
  selector: 'app-live-prices2',
  templateUrl: './live-prices2.component.html',
  styleUrls: ['./live-prices2.component.scss']
})
export class LivePrices2Component implements OnInit, OnChanges {
