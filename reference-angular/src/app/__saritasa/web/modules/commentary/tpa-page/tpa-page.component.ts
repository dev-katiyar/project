...
@Component({
  selector: 'app-tpa-page',
  templateUrl: './tpa-page.component.html',
  styleUrls: ['./tpa-page.component.scss', './../commentary.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
/** Component for TPA Page blog page */
@DestroyableComponent()
export class TpaPageComponent extends CommentaryPageBase<WpPost, WpPostFilters> {
  /** @inheritDoc */
  protected readonly filters$: BehaviorSubject<WpPostFilters> = new BehaviorSubject({
    categories: [WpPostCategories.TpaPlusTR]
  });
