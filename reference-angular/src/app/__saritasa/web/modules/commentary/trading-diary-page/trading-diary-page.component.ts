...
@Component({
  selector: 'app-trading-diary-page',
  templateUrl: './trading-diary-page.component.html',
  styleUrls: ['./trading-diary-page.component.scss', './../commentary.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
/** Component for TradingDiary blog page */
@DestroyableComponent()
export class TradingDiaryPageComponent extends CommentaryPageBase<WpPost, WpPostFilters> {
  /** @inheritDoc */
  protected readonly filters$: BehaviorSubject<WpPostFilters> = new BehaviorSubject({
    categories: [WpPostCategories.ProTrading],
  });
  ...
  public readonly items$ = this.listManager
    ...
    .pipe(
      ...
      // switchMap(posts => {
      //   return this.mediaService.getPostListMedia(posts);
      // }),
      onMessageOrFailed(() => {
        this.itemsLoading$.off();
      }),
    );
  ...
  public constructor(
    ...
    this.breadcrumbService.setItems([
      ...
      { label: 'Trading Diary', routerLink: ['/commentary/diary'] },
    ]);
  }
}
