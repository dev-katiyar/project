  ...
  <>
    ...
    <section className="sv-section surface-overlay border-bottom-1 surface-border">
      <div className="sv-content-wrap">
        <h1
          className="text-center font-bold text-color"
          style={{
          ...
          <div className="col-12 md:col-5">
            <div className="flex flex-column align-items-center gap-4 py-4">
              ...
              <p className="text-center m-0 text-color-secondary">
                Sign up for your{" "}
                <strong className="sv-text-accent">free 30-day trial</strong>{" "}
                of SimpleVisor
              </p>
            </div>
          </div>
    ...
    <section className="sv-section surface-ground">
      <div className="sv-content-wrap">
        <div
          ...
          style={{ maxWidth: 780, margin: "0 auto", lineHeight: 1.8 }}
        >
    ...
    <section className="sv-section surface-overlay">
      <div className="sv-content-wrap">
        <h2
          className="font-bold text-center text-color"
          style={{ fontSize: "2rem", margin: "0 0 2.5rem", lineHeight: 1.25 }}
        >
    ...
    {/* ── Footer CTA ── */}
    <footer
      className="surface-card text-center border-top-1 surface-border"
      style={{ padding: "3rem 1.5rem" }}
    >
      <div className="mb-4">
        <img src="/assets/home/simplevisor-light.svg" alt="SimpleVisor" style={{ height: "2.5rem" }} />
      </div>
      <h2 className="font-bold mb-4 text-color" style={{ fontSize: "1.5rem" }}>
