        ...
        {imageUrl ? (
          ...
          >
            <i
              ...
              style={{ fontSize: "2.2rem", color: "var(--sv-text-muted)", opacity: 0.35 }}
            />
          </div>
        )}
      ...
      >
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "0.4rem" }}>
            ...
            <span style={{ fontSize: "0.7rem", color: "var(--sv-text-muted)", fontWeight: 500 }}>
              {author}
            </span>
          </div>
...
const PostCardSkeleton: React.FC = () => (
  ...
  >
    <Skeleton width="190px" height="160px" borderRadius="0" />
    <div style={{ flex: 1, padding: "0.9rem 1.1rem" }}>
      ...
      <Skeleton width="75%" height="20px" borderRadius="4px" className="mb-3" />
      <Skeleton width="100%" height="13px" borderRadius="4px" className="mb-1" />
      <Skeleton width="88%" height="13px" borderRadius="4px" className="mb-1" />
      <Skeleton width="70%" height="13px" borderRadius="4px" />
    </div>
  </div>
);
...
const RecentRIAPage: React.FC = () => {
  ...
  // Derive active month filter from URL query params
  ...
  // Last N calendar months for archive sidebar
  ...
  // Reload posts whenever month/year filter or offset changes
  useEffect(() => {
    setPageFirst(0);
    ...
    <>
      ...
      <div className="mb-4">
        ...
        >
          ...
          >
            <i className="pi pi-globe" style={{ color: "var(--sv-accent)", fontSize: "1.1rem" }} />
          </div>
          <div>
