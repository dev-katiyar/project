...
stoch_signature = {
    **defaults.stoch_defaults,
    'strategies': [
        {'key': 'ca', 'name': 'cross above', 'type': 'double', 'settings': [], 'options': [defaults.fixed_defaults, defaults.stochsignal_defaults, ]},
        {'key': 'cb', 'name': 'cross below', 'type': 'double', 'settings': [], 'options': [defaults.fixed_defaults, defaults.stochsignal_defaults, ]},
        {'key': 'gt', 'name': 'greater than', 'type': 'double', 'settings': [], 'options': [defaults.fixed_defaults, defaults.stochsignal_defaults, ]},
        {'key': 'lt', 'name': 'less than', 'type': 'double', 'settings': [], 'options': [defaults.fixed_defaults, defaults.stochsignal_defaults, ]},
    ]
}
